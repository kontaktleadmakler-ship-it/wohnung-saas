...
class KalaydoScraper(BaseScraper):
    ...
    def fetch(self, url: str) -> str:
        with sync_playwright() as p:
            ...
            try:
                ...
                pass
            try:
                page.wait_for_selector("div.result-list-entry, article.result-list-entry", timeout=10000)
            except Exception:
                pass
            html = page.content()
            browser.close()
    ...
    def parse_listing_cards(self, html: str) -> list[dict]:
        ...
        cards = []
        selectors = ["div.result-list-entry", "article.result-list-entry", "div.result-item"]
